...
metaDescription: >-
  Safety should be your top priority when choosing a retreat. Learn the
  essential safety protocols, red flags, and questions every potential
  participant.
excerpt: >-
  Safety should be your top priority when choosing a retreat. Learn the
  essential safety protocols, red flags, and questions every potential
  participant.
quickAnswer: >-
  Plant medicine is powerful. Power without appropriate safeguards creates risk.
  The vast majority of serious incidents in plant medicine settings are
  attributable to inadequate safety practices, not to the medicine itself.
keyTakeaways:
  - Why Safety Matters
  - The Stakes
...
faq:
  - question: Why Safety Matters?
    answer: >-
      Plant medicine is powerful. Power without appropriate safeguards creates
      risk.
  - question: What is stakes?
    answer: >-
      Ceremony places participants in a vulnerable state. Physical coordination
      is impaired. Emotional defenses are lowered. Judgment may be altered.
  - question: What is safety and healing are not opposed?
    answer: >-
      Some people worry that emphasizing safety diminishes the depth of the
      healing experience. The opposite is true. A safe container allows deeper
      surrender, which allows deeper healing.
...
A center that provides no preparation guidance and no [integration support](/blog/integration-after-healing-retreat) is not offering a complete healing service. The ceremony itself is only one part of the process. Without the bookends of preparation and integration, outcomes are compromised.
...
- **Stimulants**: Cardiovascular risk when combinedA complete list of contraindicated medications should be provided during the screening process. If it is not, ask for one. Review our detailed [medication guide](/blog/medications-to-avoid-before-retreat).
## Heart Conditions
...
Safety extends beyond the retreat itself. Having an [integration plan](/blog/integration-after-healing-retreat) in place before you leave, including a therapist, support network, and schedule for reduced activity, ensures that the vulnerable post retreat period is adequately supported.
## Trust, But Verify
